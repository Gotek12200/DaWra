...
```{r}
# Running the models
nmf_res_5 <- nmf(dtm_matrix, k = 5, seed = 123)
nmf_res_10 <- nmf(dtm_matrix, k = 10, seed = 123)
...
X_nmf         <- as.matrix(W)
nmf5_clusters <- max.col(X_nmf, ties.method = "first")
nmf5_centers  <- as.matrix(centroids_from_labels(X_nmf, nmf5_clusters))
X_nmf5 <- W_5
X_nmf10 <- W_10
