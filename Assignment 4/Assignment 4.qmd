...
nmf5_centers  <- centroids_from_labels(X_nmf, nmf5_clusters)
...
sil_nmf5  <- sil_medoid_mean(X_nmf, nmf5_centers)
...
db_nmf5  <- index.DB(X_nmf, nmf5_clusters, centrotypes = "centroids")$DB
