...
# Chosen model
We chose linear regression as our model, since that resulted in the lower error on the dataset. It is easily interpretable unlike the deep learning model and much more computionally efficient.
